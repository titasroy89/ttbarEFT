...
class SGECluster(Cluster):
    ...
    def submit(self, prog, argument=[], cwd=None, stdout=None, stderr=None, log=None,
        ...
        #print "!=== inteded change ",text.replace('/home/schoef/genproductions_mg265UL/bin/MadGraph5_aMCatNLO/nfs','')
        #text = text.replace('/home/schoef/genproductions_mg265UL/bin/MadGraph5_aMCatNLO/nfs','')
        homePath = os.getenv("HOME")
        if homePath:
