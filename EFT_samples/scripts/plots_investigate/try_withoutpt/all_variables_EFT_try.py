    ...
    for event in events:
        ...
        for particle in particles:
            ...
            if abs(pdgId) == 6: 
                ...
                # Check if the mothers are not top
                if not any([mom and abs(mom.pdgId()) == 6 for mom in [mother1, mother2]]):
                    if mother1:
...
root_files_directory = "/nfs/dust/cms/user/beozek/EFT/CMSSW_10_6_27/src/EFT_gen_old/EFT_samples/root_files/0000/"
