...
options.register('gridpack',  '../gridpack.tar.xz',  VarParsing.VarParsing.multiplicity.singleton, VarParsing.VarParsing.varType.string,  "Which Gridpack?")
...
# with command line options: Configuration/GenProduction/python/pythiaFragmentCP5_LO_0123j.py --fileout GEN_LO_0j_102X.root --mc --eventcontent RECOSIM --datatier GEN --conditions 102X_upgrade2018_realistic_v11 --beamspot Realistic25ns13TeVEarly2018Collision --step LHE,GEN --geometry DB:Extended --era Run2_2018 --python_filename tmp.py --no_exec -n options.maxEvents
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/pythiaFragmentCP5_LO_0123j.py nevts:%i'%options.maxEvents),
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('GEN_LO_01j_102X.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    # args = cms.vstring('/eos/uscms/store/user/beozek/EFT_gen/TT01j1l_HT800_slc7_amd64_gcc700_CMSSW_10_6_19_tarball.tar.x'),
