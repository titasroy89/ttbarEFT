...
cfgPath    = os.path.expandvars( "$CMSSW_BASE/src/" )
...
config.General.requestName = "tmp_v2"
config.General.workArea = 'crab_2' + options.production_label
config.General.transferLogs = True

config.section_("JobType")
config.JobType.pluginName = 'PrivateMC'
config.JobType.psetName = 'gen_LO_01j_mc_102X_CP5.py'
